...
export function ProductDemo({
    ...
    const selectedAnimation = animationtypes[animations]

    return (
        <div className={cn("relative", className)}>
            <h2 className="text-3xl lg:text-6xl font-medium font-['DM Sans'] text-center mb-10 text-neutral-900">
                Product Demo
            </h2>
            <div
                className="relative cursor-pointer group w-[90%] max-w-4xl mx-auto"
